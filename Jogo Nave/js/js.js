function start() { 	
	$("#inicio").hide(); /*Essa div inicio irá sumir*/
	
	/* As div a seguir serão habilitadas, tornando se visíveis*/
	...
	//Verifica se um botão não está pressionado
	...
	jogo.timer = setInterval(loop,30); //É um temporizador que indica a função e o tempo de execução.
	...
	$("#inimigo1").css("top",posicaoY);		
		if (posicaoX<=0) {
		posicaoY = parseInt(Math.random() * 334); //O valor randômico é de 0 para 334
	...
	//Executa o "executaDisparo" a cada 30 segundos
